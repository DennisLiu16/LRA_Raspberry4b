...
namespace LRA_Error
{
    ...
    typedef enum{
        ...
        ERR_IOCTL_PERMISSION_DENYIED              = 0x0007,
        ...
        ERR_PI_I2C_IOCTL_PERMISSION_DENYIED    = MAKE_ERROR(DEVICE_PI_I2C,ERR_IOCTL_PERMISSION_DENYIED),
        ERR_PI_I2C_NULLPTR                     = MAKE_ERROR(DEVICE_PI_I2C,ERR_NULLPTR),
        ERR_PI_I2C_READ_FAILURE                = MAKE_ERROR(DEVICE_PI_I2C,ERR_READ_FAILURE),
        ...
        ERR_DRV2605L_REGISTER_ADDRESS_DISMATCH = MAKE_ERROR(DEVICE_DRV2605L,ERR_REGISTER_ADDRESS_DISMATCH),
        ERR_DRV2605L_NULLPTR                   = MAKE_ERROR(DEVICE_DRV2605L,ERR_NULLPTR),
