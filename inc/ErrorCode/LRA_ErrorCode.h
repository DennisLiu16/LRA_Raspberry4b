...
namespace LRA_Error
{
    ...
    typedef enum{
        ...
        ERR_DRV2605L_OPEN_PORT_FAILURE         = MAKE_ERROR(DEVICE_DRV2605L,ERR_OPEN_FAILURE),
        ERR_DRV2605L_SLAVE_ID_DISMATCH         = MAKE_ERROR(DEVICE_DRV2605L,ERR_SLAVE_ID_DISMATCH),
